diff --git a/TheLight24/api/server.py b/TheLight24/api/server.py
index 6e47601084958b7d18492af03b30c8be00381c7e..7c5f356d133fc0b4cd721bffa528b81dd1d50478 100644
--- a/TheLight24/api/server.py
+++ b/TheLight24/api/server.py
@@ -1,138 +1,189 @@
...
-LLM_BACKEND_URL = "http://127.0.0.1:8081/completion"
